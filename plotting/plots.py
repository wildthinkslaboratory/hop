...
def plot_weighted_error_control(tspan, control, title='Control'):
    plt.rcParams['ytick.labelsize'] = 8 
    plt.rcParams['xtick.labelsize'] = 8
    fig, axs = plt.subplots(3)
    fig.set_figheight(8)
...
state_lims = {
    ...
    'x1z1vx': [[-1.5, 1.5], [-1.5, 1.5], [-0.2, 1.2],[-1.5, 1.5]],
    'y115dx': [[-1.5, 1.5],[-1.5, 1.5], [-0.2, 1.2], [-1.5, 1.5]],
    'hover': [[-1.5, 1.5], [-1.5, 1.5], [-0.2, 1.2], [-1.5, 1.5]],
    'drop':  [[-1.5, 1.5], [-1.5, 1.5], [-0.2, 1.2], [-1.5, 1.5]],
    'med_perturb':  [[-1.5, 1.5], [-2.0, 1.5], [-0.2, 1.2], [-2.0, 2.0]],
    'big_perturb':  [[-1.5, 1.6], [-2.0, 1.5], [-0.2, 1.2], [-2.0, 2.0]],
...
control_lims = {
    '45dz': [[-15.0, 15.0], [0, 1.0], [-1.0, 1.0]],
    'x1z1vx': [[-15.0, 15.0], [0, 1.0], [-1.0, 1.0]],
    'y115dx': [[-15.0, 15.0], [0, 1.0], [-1.0, 1.0]],
    'hover':[[-22.0, 22.0], [-0.1, 1.0], [-1.0, 1.0]],
    'drop': [[-15.0, 15.0], [0, 1.0], [-1.0, 1.0]],
    'med_perturb': [[-22.0, 22.0], [-0.1, 1.0], [-1.0, 1.0]],
    'big_perturb': [[-22.0, 22.0], [-0.1, 1.0], [-1.0, 1.0]],
}
