...
class DroneModelRandom:
    def __init__(self):
        ...
        I_mat = ca.diag(noisy_inertia)

        F = noisy_a * u[2]**2 + noisy_b * u[2] + noisy_c
        M = noisy_d * mc.Izz * u[3]
        ...
        M_vector = ca.cross(noisy_moment_arm, F_vector) + roll_moment
        ...
        self.model.set_rhs('v', (r_b2w @ F_vector) / m_noisy + mc.g + F_wind / m_noisy)
