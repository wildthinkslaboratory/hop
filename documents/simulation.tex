...
\section*{NLP Formulations}
	...
	\begin{itemize}
		\item We stored the status result of the IPOPT solver. A result of \pythoninline{Solver_Succeeded} means that the NLP converged properly and all constraints were satisfied. In all of our experiments, we didn't encounter any NLP solutions that failed to return  \pythoninline{Solver_Succeeded}. 
