...
\begin{abstract}
	...
	Chebyshev pseudospectral collocation, and orthogonal collocation. The methods were evaluated in closed-loop simulation 
...
\begin{table}[h!]	
	\begin{center}
		\begin{tabular}{ | l | c | c | c | } 
			...
			\hline
		\end{tabular}
		\caption{Comparison of average CPU time in seconds for solution of NLP for a series of simulations on a Macbook Pro. Each simulation begins in a perturbed state and must progress to the state of being vertically balanced at $[x,y,z]$ position $[0,0,0]$. Methods include  multiple shooter (MS), orthogonal collocation (OC), and Chebyshev pseudospectral method (CPS). }
		\label{table:CPU}
	\end{center}
