...
%  We should exclude NLP misses that occur on the first iteration since we don't have a good guess then.
%  We should discuss choices for the Q matrix as part of our discussion. 
