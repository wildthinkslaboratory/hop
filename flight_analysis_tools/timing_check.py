...
def pi_to_pixhawk_clock(pi_time):
    ...
    return px4_first_send_time + px4_pi_delta + (pi_time - first_pi_time)
...
for i in range(n_cycles):
    ...
    print(state_sample, state_sent, state_receive, nmpc_start, nmpc_end)
    ...
    # ax.broken_barh([(nmpc_end, 30)], (i-0.4,0.8), facecolors='tab:purple')
